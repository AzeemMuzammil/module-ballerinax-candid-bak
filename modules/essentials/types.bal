...
public type V2JsonResponse record {
    # Response Code
    int? code?;
    ...
    string[]? errors?;
    V2JsonResponse_data? data?;
};

public type V3JsonResponse record {
    # Response Code
    int? code?;
    # Diagnostic message for response status
    string? message?;
...
public type Inline_response_200_2_data record {
    # Code for the filter_name and key_or_value results
    string? 'key?;
    # Text for the filter_name and key_or_value results
    string? value?;
...
public type V3JsonResponse_properties record {
    ...
    V3JsonResponse_properties_relationship_type? relationship_type?;
    # Organization's relation with other organizations.
    V3JsonResponse_properties_relationship_details? relationship_details?;
};
...
public type V3JsonResponse_geography record {
...
# Key value pair for filter name, value, and search_value
public type Inline_response_200_1_data record {
...
public type V3JsonResponse_taxonomies_subsection_code record {
...
public type V3JsonResponse_financials record {
    V3JsonResponse_financials_most_recent_year most_recent_year?;
...
public type V1JsonResponse_data_hits record {
    ...
    V1JsonResponse_data_properties? properties?;
};

public type V3JsonResponse_financials_most_recent_year record {
    # Tax form filing type
    string? form_types?;
...
public type V3JsonResponse_taxonomies_population_served_codes record {
...
public type V3JsonResponse_hits record {
    V3JsonResponse_organization? organization?;
    V3JsonResponse_properties? properties?;
    V3JsonResponse_geography? geography?;
    V3JsonResponse_taxonomies? taxonomies?;
    V3JsonResponse_financials? financials?;
    V3JsonResponse_dates? dates?;
};

public type V3JsonResponse_taxonomies_subject_codes record {
    # Subject code
    string? subject_code?;
...
public type V2JsonResponse_data_hits record {
    # A unique number identifying organizations and organizational entities
    string? organization_id?;
    # Deprecated Bridge ID
    string? bridge_id?;
...
public type V3JsonResponse_properties_relationship_type record {
...
public type V3JsonResponse_taxonomies_foundation_code record {
    # Foundation code that describes the organization
    string? foundation_code?;
...
public type V1JsonResponse_data record {
    # Elapsed time to calculate results
    int? took?;
    # Number of results returned by search
    int? total_hits?;
    V1JsonResponse_data_hits[]? hits?;
};
...
public type V3JsonResponse_taxonomies_ntee_codes record {
    # National Taxonomy of Exempt Entities
    string? ntee_code?;
...
public type V3JsonResponse_taxonomies record {
    V3JsonResponse_taxonomies_subject_codes[]? subject_codes?;
    V3JsonResponse_taxonomies_population_served_codes[]? population_served_codes?;
    V3JsonResponse_taxonomies_ntee_codes[]? ntee_codes?;
    V3JsonResponse_taxonomies_subsection_code? subsection_code?;
    V3JsonResponse_taxonomies_foundation_code? foundation_code?;
};

public type V3JsonResponse_dates record {
...
# Organization's relation with other organizations.
public type V3JsonResponse_properties_relationship_details record {
...
public type V3JsonResponse_organization record {
    # A unique number identifying organizations and organizational entities
    string? organization_id?;
    # Employer Identification Number
    string? ein?;
...
public type V2JsonResponse_data record {
    # Elapsed time to calculate results
    int? took?;
    # Number of results returned by search
    int? total_hits?;
    V2JsonResponse_data_hits[]? hits?;
};
...
public type V1JsonResponse_data_properties record {
    # If the organization is a parent
    boolean? parent?;
    # If the organization is a subordinate
    boolean? subordinate?;
...
public type V1JsonResponse record {
    # Response Code
    int? code?;
    # Diagnostic message for response status
    string? message?;
...
public type Inline_response_200_1 record {
    ...
    Inline_response_200_1_data[]? data?;
};
...
public type Inline_response_200_2 record {
    ...
    string[]? errors?;
    # A list of all the tables used as a filter_name with the Essentials Lookup endpoints
    Inline_response_200_2_data[]? data?;
};
